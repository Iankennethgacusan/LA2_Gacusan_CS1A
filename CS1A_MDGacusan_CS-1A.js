// First student
let first_name1 = "John Patrick";
let middle_name1 = "Mapanao";
let lastname1 = "Andaquig";
let birth_date1 = "April 24, 2006";
let birth_place1 = "Tampugo, Sta. Cruz, Ilocos Sur";
let address1 = "Tampugo, Sta. Cruz, Ilocos Sur";
let course_and_year1 = "Bachelor of Science in Computer Science (BSCS)";
let dream_job1 = "Software Developer";

// Second student
let first_name2 = "Ian Kenneth";
let middle_name2 = "Gacusan";
let lastname2 = "G";
let birth_date2 = "October 19, 2006";
let birth_place2 = "Tablac, Candon City, Ilocos Sur";
let address2 = "Tablac, Candon City, Ilocos Sur";
let course_and_year2 = "Bachelor of Science in Computer Science (BSCS) 1st Year";
let dream_job2 = "Professional Programmer";
